                ...
                <div class="logo-slider-inner">
                    <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                        <div class="item m-t-15"><a href="#" class="image"> <img
                                        data-echo="{{ asset('images/brands/brand1.png') }}" src="{{ asset('images/blank.gif') }}"
                                        alt=""> </a></div>
                        <!--/.item-->

                        <div class="item m-t-10"><a href="#" class="image"> <img
                                        data-echo="{{ asset('images/brands/brand2.png') }}" src="{{ asset('images/blank.gif') }}"
                                        alt=""> </a></div>
                        <!--/.item-->

                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand3.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->

                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand4.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->

                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand5.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->

                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand6.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->

                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand2.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->
                        ...
                        <div class="item"><a href="#" class="image"> <img data-echo="{{ asset('images/brands/brand1.png') }}"
                                                                          src="{{ asset('images/blank.gif') }}" alt=""> </a>
                        </div>
                        <!--/.item-->
