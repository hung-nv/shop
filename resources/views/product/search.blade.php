        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <li class='active'>Tìm kiếm: {{ $name }}</li>
                </ul>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="fld inline">
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                ...
                                                <ul role="menu" class="dropdown-menu">
                                                    ...
                                                    <li role="presentation">
                                                        <a v-on:click="setSortType('4')">Tên sản phẩm: A -
                                                            Z</a>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="col col-sm-3 col-md-6 no-padding">
                                    <div class="lbl-cnt"><span class="lbl">Show</span>
                                        <div class="fld inline">
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                <button data-toggle="dropdown" type="button"
                                                        class="btn dropdown-toggle"> @{{ pageSize }} sản phẩm <span
                                                            class="caret"></span>
                                                </button>
                                                <ul role="menu" class="dropdown-menu">
                                                    <li role="presentation"><a v-on:click="setPageSize('12')">12 sản
                                                            phẩm</a></li>
                                                    <li role="presentation"><a v-on:click="setPageSize('24')">24 sản
                                                            phẩm</a></li>
                                                    <li role="presentation"><a v-on:click="setPageSize('36')">36 sản
                                                            phẩm</a></li>
                                                    <li role="presentation"><a v-on:click="setPageSize('48')">48 sản
                                                            phẩm</a></li>
                                                </ul>
                                            </div>
                                        </div>
